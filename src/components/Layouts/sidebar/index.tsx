  ...
  return (
    <>
      ...
      <aside
        ...
        inert={!isOpen}
      >
        <div className="flex h-full flex-col py-8 pl-[25px] pr-[8px]">
          <div className="relative pr-4.5">
            <Link
              href={"/"}
              onClick={() => isMobile && toggleSidebar()}
              className="px-0 py-2 min-[600px]:py-0"
            >
              <Logo />
            </Link>
          ...
          {/* Navigation */}
          <div className="custom-scrollbar mt-2 flex-1 overflow-y-auto pr-3 min-[850px]:mt-6">
