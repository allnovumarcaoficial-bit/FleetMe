...
CREATE TABLE "Vehicle" (
    ...
    "fecha_vencimiento_licencia_operativa" TIMESTAMP(3),
    "km_recorrido" DOUBLE PRECISION NOT NULL DEFAULT 0,
    "photo_Car" TEXT,
    "fecha_vencimiento_circulacion" TIMESTAMP(3),
    "fecha_vencimiento_somaton" TIMESTAMP(3),
