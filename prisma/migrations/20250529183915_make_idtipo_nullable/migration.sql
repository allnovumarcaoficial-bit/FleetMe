...
CREATE TABLE "new_Vehicle" (
    ...
    "idtipo" INTEGER,
    CONSTRAINT "Vehicle_idtipo_fkey" FOREIGN KEY ("idtipo") REFERENCES "VehicleType" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_Vehicle" ("estado", "fecha_compra", "fecha_vencimiento_circulacion", "fecha_vencimiento_licencia_operativa", "fecha_vencimiento_somaton", "gps", "id", "idtipo", "listado_municipios", "marca", "matricula", "modelo", "vin") SELECT "estado", "fecha_compra", "fecha_vencimiento_circulacion", "fecha_vencimiento_licencia_operativa", "fecha_vencimiento_somaton", "gps", "id", "idtipo", "listado_municipios", "marca", "matricula", "modelo", "vin" FROM "Vehicle";
DROP TABLE "Vehicle";
