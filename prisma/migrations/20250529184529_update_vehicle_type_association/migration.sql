/*
  ...
  - You are about to drop the column `idtipo` on the `Vehicle` table. All the data in the column will be lost.
...
CREATE TABLE "new_Vehicle" (
    ...
    CONSTRAINT "Vehicle_tipoVehiculoId_fkey" FOREIGN KEY ("tipoVehiculoId") REFERENCES "VehicleType" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
